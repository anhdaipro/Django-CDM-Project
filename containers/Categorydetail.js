...
let PageSize=30
const Categorydetail = ({data,searchitem,listitem,setsearchitem,params}) => {
            ...
            <div className="containers _3wA4TW">
                <div className="ofs-carousel">
                    <div className="ofs-carousel__header">
                        <a className="ofs-carousel__header-left ofs-carousel__header-left--clickable" href="/mall/Thời-Trang-Nam-cat.11035567">Shopee Mall</a>
                        <a className="ofs-carousel__header-right" href="/mall/brands/11035567">
                                    ...
                                    <li className="image-carousel__item" style={{padding: '0px',width: '16.6667%'}}>
                                        <div className="ofs-carousel__column ofs-carousel__column--two-row">
                                            <div className="ofs-carousel__item">
                                                <a className="ofs-carousel__shop-cover-image" href="/sp.btw2">
                                            ...
                                            <div className="ofs-carousel__item">
                                                <a className="ofs-carousel__shop-cover-image" href="/coolmate.vn">
                                                    <div className="_25_r8I">
                                            ...
                                            <div className={`checkbox ${search.categoryID!=undefined && search.categoryID==category.id?'checkbox--checked':''}`}>
                                                <label className="checkbox__control">
                                                    ...
                                                    <div className={`checkbox__box ${search.categoryID!=undefined && search.categoryID==category.id?'checkbox__box--checked':''}`}>
                                                        ...
                                                        <svg enable-background="new 0 0 12 12" viewBox="0 0 12 12" x="0" y="0" class="svg-icon icon-checkbox-ticked checkbox__tick icon-tick-bold"><g><path d="m5.2 10.9c-.2 0-.5-.1-.7-.2l-4.2-3.7c-.4-.4-.5-1-.1-1.4s1-.5 1.4-.1l3.4 3 5.1-7c .3-.4 1-.5 1.4-.2s.5 1 .2 1.4l-5.7 7.9c-.2.2-.4.4-.7.4 0-.1 0-.1-.1-.1z"></path></g></svg>
                                                        :<i> </i>}
                                                    </div>
